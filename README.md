...
```javascript
isEqualInt8Array = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-equal-int8array@v0.1.0-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-equal-int8array@v0.1.0-umd/browser.js"></script>
```
